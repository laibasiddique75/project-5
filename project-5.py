...
if choice == "Home":
    ...
    st.markdown("""
        ...
        - 🧠 The system operates entirely in memory (no external DBs).
    """)
...
# === Register ===
    ...
    if st.button("Register"):
        if username and password:
            ...
            st.error("⚠️ Please fill in all fields to register.")
...
# === Login ===
    ...
    if time.time() < st.session_state.lockout_time:
        ...
        st.error(f"⏳ Too many failed attempts. Please wait {remaining} seconds to try again.")
        st.stop()
